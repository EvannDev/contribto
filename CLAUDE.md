...
Ce fichier guide Claude Code quand il travaille dans ce repo. Lis-le avant toute action.

---

## Projet

**HelloCommit** — web app qui aide les développeurs à trouver des **Good First Issues** sur GitHub, basées sur les repos qu'ils ont starrés.
